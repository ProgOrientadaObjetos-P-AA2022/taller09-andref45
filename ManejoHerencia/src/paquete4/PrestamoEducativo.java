...
public class PrestamoEducativo extends Prestamo {
    ...
    private InstitucionEducativa c_educ;
    private double v_c;
    private double vM;

    public PrestamoEducativo(Persona b, int mes, String ciud, String niv,
            InstitucionEducativa c_ed, double v_C) {
        super(b, mes, ciud);
        nivel = niv;
        c_educ = c_ed;
        v_c = v_C;
    ...
    public void establecerC_educ(InstitucionEducativa n) {
        c_educ = n;
    }
    ...
    public InstitucionEducativa obtenerC_educ() {
        return c_educ;
    }
